"""
Django settings for JMprojet project.
...
SECRET_KEY = 'django-insecure-se$i(p$*&h+nlh_(0_in20#!oblumsw97r!#mhqxbk7m*je(nq'
...
WSGI_APPLICATION = 'JMprojet.wsgi.application'
